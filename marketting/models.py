...
def marketing_pref_create_receiver(sender, instance, created, *args, **kwargs):
    if created:
        print("Email is",instance.user.email)
        status_code, response_data = Mailchimp().subscribe(instance.user.email)
        print(status_code, response_data)


post_save.connect(marketing_pref_create_receiver, sender=MarkettingPreference)
...
pre_save.connect(marketing_pref_update_receiver, sender=MarkettingPreference)
